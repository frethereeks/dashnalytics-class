...
export default function ErrorPage() {
  return (
    <main className="grid place-items-center min-h-screen min-full w-full bg-primary">
      <aside className="bg-white rounded-md w-full max-w-md flex flex-col gap-3 p-6 text-center text-dark shadow-lg mx-auto">
        ...
        <p className="font-medium text-dark text-lg md:text-2xl w-max mx-auto p-2 my-2 border-y border-dotted border-dark/30">
          page NOT found
        </p>
